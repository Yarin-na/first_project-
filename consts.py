...
RED = (240,128,128) #(255, 89, 94)
GREEN = (138, 201, 38)
BLUE = (25, 130, 196)
ORANGE = (255, 202, 58)
CADETBLUE = (122,197,205)
VIOLET = (106, 76, 147)
BLACK = (0, 0, 0)
BURLYWOOD = (238,197,145)
GOLDENROD = (255,236,139)
MEDIUMSEAGREEN = (154,255,154)
ORCHID = (238,122,233)
BACKGROUND_COLOR = (254, 252, 252)
BUBBLE_START_COLORS = [RED,MEDIUMSEAGREEN, GOLDENROD, BURLYWOOD, CADETBLUE, ORCHID]
